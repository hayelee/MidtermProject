...
@WebServlet("/cutOffCancle.do")
public class CutOffCancleController extends HttpServlet {
...
private static final long serialVersionUID = 1L;
	...
	@Override
		...
		System.out.println("차단delete 파라미터 vo : " + com);
		
		//차단이 이미 되어있으면?
		int cnt = cos.deleteCutOffMem(com);
		...
		req.getRequestDispatcher("/WEB-INF/view/mypage/yourPage.jsp").forward(req, resp);
	}
