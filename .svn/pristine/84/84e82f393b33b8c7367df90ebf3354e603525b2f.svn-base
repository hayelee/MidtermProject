...
<% 
	MemReportVO mrv = (MemReportVO) request.getAttribute("mrv");
%>	
	<!-- CSS -->
	<style>
	table {
		        ...
		        <div class="container">
		            <table class="board-table">
		                ...
		                <tr>
		                    ...
		                    <th scope="col" class="th-num">회원 신고 내용</th>
		                    <th scope="col" class="th-date">회원 신고일</th>
		                    <th scope="col" class="th-date">신고 회원 ID</th>
		                    <th scope="col" class="th-date">피신고 회원 ID</th>
		            ...
		            <a href="delete.do?memReportId=<%=mrv.getMemReportId()%>">[회원 신고글 삭제]</a>
		            <a href="<%=request.getContextPath()%>/memReport/list.do">[신고 회원 목록]</a>
		        </div>
		    </div>
